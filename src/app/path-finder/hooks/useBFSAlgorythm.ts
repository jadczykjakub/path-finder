...
function useBFSAlgorythm({ setMaze, maze, mazeDimension }: TUseBFSAlgorytm) {
        ...
        prevMaze.map((row, rowIndex) =>
          row.map((cell, cellIndex) => {
            if (rowIndex === y && cellIndex === x) {
                ...
                //tutaj end zmieniamy na znalezione
                console.log(cell, "is visited")
  ...
  return { bfs, bfsRefresh };
}

export default useBFSAlgorythm;
